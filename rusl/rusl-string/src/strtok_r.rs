...
/// - `sep` 非空，以 null 结尾
#[no_mangle]
pub unsafe extern "C" fn strtok_r(s: *mut core::ffi::c_char, sep: *const core::ffi::c_char, p: *mut *mut core::ffi::c_char) -> *mut core::ffi::c_char {
    ...
    loop {
        ...
        if is_sep {
            unsafe { *pos = 0; }
            *p = unsafe { pos.add(1) } as *mut core::ffi::c_char;
            return token as *mut core::ffi::c_char;
        }
        pos = unsafe { pos.add(1) };
    }
