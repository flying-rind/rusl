...
use crate::import::syscall::{raw_syscall1, raw_syscall3, raw_syscall5};
use crate::import::syscall::{SYS_exit, SYS_exit_group, SYS_open};
...
pub unsafe extern "C" fn __init_libc(envp: *mut *mut c_char, pn: *const c_char) {
    ...
    let r = {
        use crate::import::syscall::SYS_poll;
    ...
    let r = {
        ...
        use crate::import::syscall::SYS_ppoll;
        #[repr(C)]
